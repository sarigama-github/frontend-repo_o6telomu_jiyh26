...
import { Menu, Shield, Phone, LockKeyhole } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <p className="text-sm uppercase tracking-widest text-white/60">Avicenna</p>
            <p className="font-semibold">Smart World</p>
          </div>
        </div>
